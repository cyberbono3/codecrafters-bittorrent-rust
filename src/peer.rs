...
use tokio_util::{codec::Decoder, codec::Encoder, codec::Framed};
...
impl Peer {
    ...
    pub async fn download(
        ...
        let mut request = Request::new(
            piece_i as u32,
            (block_i as usize * BLOCK_MAX) as u32,
            block_size as u32,
        );
    ...
    pub(crate) async fn participate(
        ...
        // it will continuesly receive the tasks it is gonna download
        anyhow::ensure!(self.bitfield.has_piece(piece_i));
        ...
        'task: loop {
            while self.choked {
                ...
                match unchoke.tag {
                    ...
                    MessageTag::Have => {
                        // TODO HAVE means peer should be eligible for more pieces
                    ...
                    MessageTag::Piece => {
                        // piece we no longer need
                    }
                    MessageTag::Choke => {
                        anyhow::bail!("peer sent unchoke while unchoke");
                    }
                    MessageTag::Bitfield => {
            ...
            loop {
                ...
                match msg.tag {
                    ...
                    MessageTag::Piece => {
                        ...
                        {
                            // piece we no longer needed
                        } else {
                            // thr piece we are looking for
                            // otherwise
...
fn bitfield_has() {
    let bf = Bitfield {
        payload: vec![0b10101010, 0b1010101],
    };
